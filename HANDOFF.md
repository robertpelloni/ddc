...
- Updated versioning/documentation files to `0.2.25`.
...
- The current active frontier still appears to be `dance-single_Medium`, supported by newer checkpoint timestamps than `dance-single_Easy`, an observed `model_07.pth`, and a later in-flight `Epoch 8/10` log window.
